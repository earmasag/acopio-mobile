...
export function LoadActionCard({
  title,
  description,
  icon,
  iconClass,
  ...
  return (
    <Pressable
      className="flex-row items-center gap-4 rounded-2xl border border-sky-200 bg-white p-4 shadow-sm active:opacity-90"
      onPress={onPress}
    >
      <View
